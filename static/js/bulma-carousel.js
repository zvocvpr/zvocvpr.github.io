    ...
    ((modules) => {
      ...
      /******/ [
        ...
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          ...
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", () => removeClasses)
          /* unused harmony export show */
          /* unused harmony export hide */
          /* unused harmony export offset */
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", () => width)
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", () => height)
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", () => outerHeight)
          /* unused harmony export outerWidth */
          /* unused harmony export position */
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", () => css)
        ...
        /* 2 */
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", () => isFunction)
          /* unused harmony export isNumber */
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", () => isString)
          /* unused harmony export isDate */
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", () => isObject)
          ...
          var isDate = function isDate(unknown) {
            return (
              (Object.prototype.toString.call(unknown) === "[object Date]" || unknown instanceof Date) &&
          ...
          var isObject = function isObject(unknown) {
            return (
              (typeof unknown === "function" ||
                ((typeof unknown === "undefined" ? "undefined" : _typeof(unknown)) === "object" && !!unknown)) &&
          ...
          var isYoutube = function isYoutube(unknown) {
            return (
              isIFrame(unknown) &&
              !!unknown.src.match(/\/\/.*?youtube(-nocookie)?\.[a-z]+\/(watch\?v=[^&\s]+|embed)|youtu\.be\/.*/)
            )
          }
            ...
            _createClass(EventEmitter, [
              {
                ...
                value: function on(name, cb) {
                  ...
                  this.events.set(
                    name,
                    [].concat(_toConsumableArray(this.events.has(name) ? this.events.get(name) : []), [cb]),
                  )
              ...
              },
              {
                ...
                value: function emit(name) {
                  ...
                  return this.events.has(name) && this.events.get(name).map((fn) => fn.apply(undefined, args))
                },
              },
            ])
        ...
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          ...
          var bulmaCarousel = ((_EventEmitter) => {
            ...
            function bulmaCarousel(selector) {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (bulmaCarousel.__proto__ || Object.getPrototypeOf(bulmaCarousel)).call(this),
              )
              ...
              var elementConfig = _this.element.dataset
                ? Object.keys(_this.element.dataset)
                    .filter((key) =>
                      Object.keys(__WEBPACK_IMPORTED_MODULE_12__defaultOptions__["a" /* default */]).includes(key),
                    )
                    .reduce((obj, key) => _extends({}, obj, _defineProperty({}, key, _this.element.dataset[key])), {})
                : {}
                  ...
                  value: function _build() {
                    ...
                    this.node = document
                      ...
                      .createContextualFragment(
                        Object(__WEBPACK_IMPORTED_MODULE_13__templates__["a" /* default */])(this.id),
                      )
                    ...
                    this._transitioner = new __WEBPACK_IMPORTED_MODULE_11__components_transitioner__["a" /* default */](
                      this,
                    )

                    // Wrap all items by slide element
                    this._slides = this._items.map((item, index) => this._createSlide(item, index))
                ...
                },
                {
                  ...
                  value: function _createSlide(item, index) {
                    var slide = document
                      .createRange()
                      .createContextualFragment(
                        Object(__WEBPACK_IMPORTED_MODULE_14__templates_item__["a" /* default */])(),
                      ).firstChild
                  ...
                  value: function _setDimensions() {
                    ...
                    if (!this.options.vertical) {
                      ...
                      this._ui.wrapper.style.height =
                        Object(__WEBPACK_IMPORTED_MODULE_1__utils_css__["c" /* outerHeight */])(this._slides[0]) *
                        this.slidesToShow
                      if (this.options.centerMode) {
                    ...
                    this._wrapperWidth = Object(__WEBPACK_IMPORTED_MODULE_1__utils_css__["e" /* width */])(
                      this._ui.wrapper,
                    )
                    this._wrapperHeight = Object(__WEBPACK_IMPORTED_MODULE_1__utils_css__["c" /* outerHeight */])(
                      this._ui.wrapper,
                    )
                  ...
                  value: function _setHeight() {
                    if (this.options.effect !== "translate") {
                      this._ui.container.style.height =
                        Object(__WEBPACK_IMPORTED_MODULE_1__utils_css__["c" /* outerHeight */])(
                ...
                },
                {
                  ...
                  value: function _setClasses() {
                    ...
                    this._slides.forEach((slide) => {
                      ...
                      if (
                        Math.abs((this.state.index - 1) % this.state.length) ===
                        Number.parseInt(slide.dataset.sliderIndex, 10)
                      ) {
                        slide.classList.add("is-slide-previous")
                      }
                      if (
                        Math.abs(this.state.index % this.state.length) ===
                        Number.parseInt(slide.dataset.sliderIndex, 10)
                      ) {
        ...
        /* 6 */
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", () => uuid)
                ...
                value: function _bindEvents() {
                  ...
                  if (this.slider.options.pauseOnHover) {
                    this.slider.container.addEventListener(
                      __WEBPACK_IMPORTED_MODULE_1__utils_device__["a" /* pointerEnter */],
                      this.onMouseEnter,
                    )
                    this.slider.container.addEventListener(
                      __WEBPACK_IMPORTED_MODULE_1__utils_device__["b" /* pointerLeave */],
                      this.onMouseLeave,
                    )
                  }
                },
        ...
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          ...
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", () => pointerEnter)
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", () => pointerLeave)
            ...
            _createClass(Breakpoints, [
              {
                ...
                value: function init() {
                  ...
                  this.options.breakpoints.sort(
                    (a, b) => Number.parseInt(a.changePoint, 10) > Number.parseInt(b.changePoint, 10),
                  )
                ...
                value: function init() {
                  if (this.slider.options.infinite && this.slider.options.effect === "translate") {
                    ...
                    for (
                      ...
                      slideIndex = i - 1
                      frontClones.unshift(
                        this._cloneSlide(this.slider.slides[slideIndex], slideIndex - this.slider.state.length),
                      )
                    }
        ...
        /* 12 */
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", () => isInViewport)
          ...
          var Navigation = (() => {
            function Navigation(slider) {
              ...
              this._supportsPassive = Object(
                __WEBPACK_IMPORTED_MODULE_1__utils_detect_supportsPassive__["a" /* default */],
              )()
            ...
            _createClass(Navigation, [
              {
                ...
                value: function init() {
                  this.node = document
                    .createRange()
                    .createContextualFragment(
                      Object(__WEBPACK_IMPORTED_MODULE_0__templates_navigation__["a" /* default */])(
        ...
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          ...
          var Pagination = (() => {
            function Pagination(slider) {
              ...
              this._clickEvents = ["click", "touch"]
              this._supportsPassive = Object(
                __WEBPACK_IMPORTED_MODULE_2__utils_detect_supportsPassive__["a" /* default */],
              )()
            ...
            _createClass(Pagination, [
              {
                ...
                value: function init() {
                  ...
                  this.node = document
                    .createRange()
                    .createContextualFragment(
                      Object(__WEBPACK_IMPORTED_MODULE_0__templates_pagination__["a" /* default */])(),
                    )
                  this._ui = {
                  ...
                  this._count = Math.ceil(
                    (this.slider.state.length - this.slider.slidesToShow) / this.slider.slidesToScroll,
                  )
                  ...
                  if (this.slider.options.pagination && this.slider.state.length > this.slider.slidesToShow) {
                    for (var i = 0; i <= this._count; i++) {
                      var newPageNode = document
                        .createRange()
                        .createContextualFragment(
                          Object(__WEBPACK_IMPORTED_MODULE_1__templates_pagination_page__["a" /* default */])(),
                        ).firstChild
              ...
              },
              {
                ...
                value: function refresh() {
                  ...
                  this._pages.forEach((page) => {
                    ...
                    if (Number.parseInt(page.dataset.index, 10) === this.slider.state.next % this.slider.state.length) {
        ...
        /* 16 */
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony default export */ __webpack_exports__["a"] = () => '<div class="slider-pagination"></div>'

          /***/
        },
        /* 17 */
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony default export */ __webpack_exports__["a"] = () => '<div class="slider-page"></div>'
            ...
            _createClass(Swipe, [
              ...
              },
              {
                ...
                value: function onStartDrag(e) {
                  ...
                  this._origin = new __WEBPACK_IMPORTED_MODULE_0__utils_coordinate__["a" /* default */](
                    e.screenX,
                    e.screenY,
                  )
        ...
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          ...
          var Transitioner = (() => {
            function Transitioner(slider) {
              ...
              this._translate = new __WEBPACK_IMPORTED_MODULE_1__transitions_translate__["a" /* default */](
                this,
                slider,
                slider.options,
              )
              this._fade = new __WEBPACK_IMPORTED_MODULE_0__transitions_fade__["a" /* default */](
                this,
                slider,
                slider.options,
              )
              ...
              },
              {
                ...
                value: function enable() {
                  ...
                  this._oldSlide = this.slider.slides.filter(
                    (slide) => slide.dataset.sliderIndex == this.slider.state.index,
                  )[0]
                  this._newSlide = this.slider.slides.filter(
                    (slide) => slide.dataset.sliderIndex == this.slider.state.next,
                  )[0]
                  if (this._newSlide) {
              ...
              },
              {
                ...
                value: function apply() {
                  ...
                  if (this.options.effect === "translate") {
                    ...
                    var slideOffset = new __WEBPACK_IMPORTED_MODULE_0__utils_coordinate__["a" /* default */](
                      slide.offsetLeft,
                      slide.offsetTop,
                    )
                    if (this.options.centerMode) {
                    ...
                    if (this.options.centerMode) {
                      this._position.x =
                        ...
                        Object(__WEBPACK_IMPORTED_MODULE_1__utils_css__["e" /* width */])(slide) / 2
                    }
        ...
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony default export */ __webpack_exports__["a"] = (id) =>
            '<div id="' + id + '" class="slider" tabindex="0">\n    <div class="slider-container"></div>\n  </div>'

          /***/
        },
        /* 24 */
        /***/ (module, __webpack_exports__, __webpack_require__) => {
          /* harmony default export */ __webpack_exports__["a"] = () => '<div class="slider-item"></div>'
