!((t, e) => {
  ...
  () =>
    ((n) => {
      ...
      (t, e, n) => {
        Object.defineProperty(e, "__esModule", { value: !0 }), n.d(e, "isString", () => l)
        var r = n(1),
          i =
            Object.assign ||
            ((t) => {
          ...
          u = (() => {
            ...
            return (t, e, n) => (e && r(t.prototype, e), n && r(t, n), t)
          })(),
          o =
                ...
                [
                  {
                    ...
                    value: function () {
                      if (
                        ((this._id =
                          "bulmaSlider" + new Date().getTime() + Math.floor(Math.random() * Math.floor(9999))),
                    ...
                    value: function () {
                      ...
                      return (
                        Array.from(t).forEach((t) => {
                          if (t.htmlFor == this.element.getAttribute("id")) return (n = t), !0
                        }),
                        n
                      )
                    },
                  },
                  {
                    ...
                    value: function () {
                      var t,
                        ...
                        n = Number.parseInt(e.getPropertyValue("width"), 10)
                ...
                [
                  {
                    ...
                    value: function () {
                      var t =
                          0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : 'input[type="range"].slider',
                        r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
                        i = new Array()
                      return (
                        (l(t) ? document.querySelectorAll(t) : Array.isArray(t) ? t : [t]).forEach((t) => {
                          if (void 0 === t[this.constructor.name]) {
                            var e = new o(t, r)
                            ;(t[this.constructor.name] = e), i.push(e)
                          } else i.push(t[this.constructor.name])
                        }),
                        i
                      )
                    },
            ...
            r(e, [
              ...
              },
              {
                ...
                value: function () {
                  ...
                  null !== t
                    ? Array.isArray(t)
                      ? name.forEach((t) => this.removeListeners(t, n))
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  Array.isArray(t)
                    ? name.forEach((t) => this.middleware(t, e))
              ...
              },
              {
                ...
                value: function () {
                  ...
                  null !== t
                    ? Array.isArray(t)
                      ? name.forEach((t) => this.removeMiddleware(t))
              ...
              },
              {
                ...
                value: function (t, e) {
                  ...
                  if (Array.isArray(t)) t.forEach((t) => this.on(t, e))
                  else {
                    var i = (t = t.toString()).split(/,|, | /)
                    1 < i.length
                      ? i.forEach((t) => this.on(t, e))
